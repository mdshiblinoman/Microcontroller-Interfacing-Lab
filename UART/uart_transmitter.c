/* ================================================================
 * USART1 BOARD A ("TRANSMITTER") - STM32F446RE
 * Bare-metal, register-level, NO HEADER FILES INCLUDED.
 * ================================================================
 *
 * IMPORTANT NOTE ON NAMING
 * ----------------------------------------------------------------
 * This file is called the "Transmitter" only to match the naming
 ...
 * for the other board's button state - exactly like uart_receiver.c
